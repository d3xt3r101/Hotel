...
include 'C:\xampp\htdocs\Hotel\controller\controller.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="admin/index.php">Admin <span>Login</span><p class="logo_w3l_agile_caption">Panel</p></a></h1>
				</div>
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile2" data-aos="flip-left">
			<div class="contact-agileits">
				...
				if(isset($_POST['sub']))
				{
					...
					$obj1=new Cntr();
					$obj1->createRes($name,$phone,$email,$approval);
